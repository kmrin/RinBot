...
from program.kobold.custom_memory import CustomBufferWindowMemory
...
# Stop sequences
STOP_SEQUENCES = os.getenv("AI_STOP_SEQUENCES")
try:
    STOP_SEQUENCES = STOP_SEQUENCES.replace("\\n", "\n")
    STOP_SEQUENCES = STOP_SEQUENCES.split(",")
except AttributeError:
    print("[languagemodel.py]-[ERROR]: STOP_SEQUENCES not defined in .env")
    pass
